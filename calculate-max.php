    ...
    if($_GET){
        ...
        if ( $firstNum > $secondNum ){
            ...
            if ( $firstNum > $thirdNum ){
                return "Number " . $firstNum . " is the max";
            }
            elseif ( $firstNum === $thirdNum ) {
                ...
                return "Number " . $thirdNum . " is the max";
            }
        ...
        elseif($secondNum > $firstNum){
            ...
            if ( $secondNum > $thirdNum ){
                return "Number " . $secondNum . " is the max";
            }
...
<html lang="en">
 ...
 <!-- container to hold all inputs of form  -->
    ...
    <h1 class="mb-3" style="text-align:center;font-weight:bold">Calculate MAX</h1>
        <form method="GET">
