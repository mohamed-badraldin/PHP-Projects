...
<html lang="en">
  ...
  <body>
    ...
    <h1 style="text-align:center; font-weight:bold" class="mb-3">Calculate-specific-root</h1>
        ...
        <div class="col-6  offset-3">
            <div class="input-group mb-2 input-group-lg">
                <div class="input-group-prepend">
                <div class="input-group-text">The Root</div>
                </div>
                <input type="number" class="form-control" name ="root">
            </div>
        </div>
